...
// other Chambers register and gather around.
...
// Notes: two shapes overlapping — its signature feature is wiki-links and
// backlinks, so the mark is the intersection itself, not a page or a pen.
...
// Calendar: a nested-square spiral — reads as a grid of dates receding
// toward a point, distinct from the plain diamond fallback it used to share
// with DefaultChamberMark.
...
// Documents: a square bound by a looping line — the file, and the paper
// trail connecting it to what references it.
