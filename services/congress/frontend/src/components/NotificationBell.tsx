...
// Congress's own inbox - the one place every log rule's "task due", "event
// starting soon" (etc.) alert surfaces. Fixed top-right chrome of the shell
// (see App.tsx), so it's reachable from the homepage and from inside any
// Chamber. The panel stays position:fixed at every breakpoint.
